       ...
       <div class="col-md-6 col-lg-6 col-xl-3">
          <div class="card mg-b-30">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center tx-gray-500 tx-11"><span class="tx-danger mr-2 d-flex align-items-center"><i class="ti-arrow-down tx-8 mr-1 tx-8"></i>-1,003</span>since last day</div>
             </div>
          </div>
       </div>
       <div class="col-md-6 col-lg-6 col-xl-3">
          <div class="card mg-b-30">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center tx-gray-500 tx-11"><span class="tx-success mr-2 d-flex align-items-center"><i class="ti-arrow-up tx-8 mr-1 tx-8"></i>+2,012</span>since last day</div>
             </div>
          </div>
       </div>
       <div class="col-md-6 col-lg-6 col-xl-3">
          <div class="card mg-b-30">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center tx-gray-500 tx-11"><span class="tx-danger mr-2 d-flex align-items-center"><i class="ti-arrow-down tx-8 mr-1 tx-8"></i>-1,120</span>since last month</div>
             </div>
          </div>
       </div>
       <!--/ Heard Card End -->               
                      ...
                      <div class="row mg-b-20">
                         <div class="col-sm-12 col-md-6 col-xl-12 mg-t-0">
                            ...
                            <div class="d-flex align-items-end justify-content-between mg-b-5">
                               ...
                               <div class="d-flex align-items-center tx-gray-700"><span class="small text-success mr-2 d-flex align-items-center"><i class="ti-arrow-up mr-1 tx-8"></i>+351</span></div>
                            </div>
                         ...
                         <div class="col-sm-12 col-md-6 col-xl-12 mg-t-30 mg-md-t-0 mg-xl-t-30">
                            <div class="d-flex justify-content-between">
                               <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 mg-b-2">Today Earning</h6>
                            </div>
                            <div class="d-flex align-items-end justify-content-between mg-b-5">
                               <h5 class="mg-b-0 tx-dark tx-rubik tx-normal"><span class="counter">$2,530</span></h5>
                               <div class="d-flex align-items-center tx-gray-700"><span class="small text-success mr-2 d-flex align-items-center"><i class="ti-arrow-up mr-1 tx-8"></i>+425</span></div>
                            </div>
                            <div class="progress ht-3 mg-b-0">
                         ...
                         <div class="col-sm-12 col-md-6 col-xl-12 mg-t-30">
                            <div class="d-flex justify-content-between">
                               <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 mg-b-2">Average Order</h6>
                            </div>
                            <div class="d-flex align-items-end justify-content-between mg-b-5">
                               <h5 class="mg-b-0 tx-dark tx-rubik tx-normal"><span class="counter">$2,148</span></h5>
                               <div class="d-flex align-items-center tx-gray-700"><span class="small text-danger mr-2 d-flex align-items-center"><i class="ti-arrow-down mr-1 tx-8"></i>-211</span></div>
                            </div>
                            <div class="progress ht-3 mg-b-0">
                         ...
                         <div class="col-sm-12 col-md-6 col-xl-12 mg-t-30">
                            <div class="d-flex justify-content-between">
                               <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 mg-b-2">Total Revenue</h6>
                            </div>
                            <div class="d-flex align-items-end justify-content-between mg-b-5">
                               <h5 class="mg-b-0 tx-dark tx-rubik tx-normal"><span class="counter">$11,290</span></h5>
                               <div class="d-flex align-items-center tx-gray-700"><span class="small text-success mr-2 d-flex align-items-center"><i class="ti-arrow-up mr-1 tx-8"></i>+151</span></div>
                            </div>
                            <div class="progress ht-3 mg-b-0">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-12">
                   <div class="media pd-t-20 pd-x-20">
                      ...
                      <div class="media-body">
                         ...
                         <h5 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">$51,958<small class="tx-12">.50</small></h5>
                      </div>
                   </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-12">
                   <div class="media pd-y-20 pd-x-20">
                      <div class="wd-40 ht-40 bg-warning tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded">
                         <i data-feather="bar-chart-2"></i> 
                      </div>
                      <div class="media-body">
                         <h6 class="tx-uppercase tx-10 tx-spacing-1 tx-gray-500 mg-b-5">Net Earnings</h6>
                         <h5 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">$31,608<small class="tx-12">.50</small></h5>
                      </div>
                   </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-12">
                   <div class="media pd-b-20 pd-x-20 pd-md-t-20 pd-xl-t-0">
                      <div class="wd-40 ht-40 bg-pink tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded">
                         <i data-feather="bar-chart-2"></i> 
                      </div>
                      <div class="media-body">
                         <h6 class="tx-uppercase tx-10 tx-spacing-1 tx-gray-500 mg-b-5">Tax Withheld</h6>
                         <h5 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">$24,769<small class="tx-12">.50</small></h5>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div class="card-body pd-b-0">
                <div class="row mg-b-20">
                   <div class="col-lg-6">
                      ...
                      <div class="tx-12 tx-gray-500">Customers who have upgraded the level of your products or service.</div>
                   </div>
                ...
                <div class="row clearfix mg-b-20">
                   <div class="col-md-4 col-lg-4 col-xl-4 mg-t-20 mg-sm-t-0 mg-md-t-20 mg-lg-t-0">
                      <div class="media">
                         ...
                         <div class="media-body mg-l-10">
                            <p class="tx-10 tx-uppercase tx-primary tx-spacing-1 mg-b-0 tx-medium">Expansions</p>
                   ...
                   <div class="col-md-4 col-lg-4 col-xl-4 mg-t-20 mg-sm-t-0 mg-md-t-20 mg-lg-t-0">
                      <div class="media">
                         ...
                         <div class="media-body mg-l-10">
                            <p class="tx-10 tx-uppercase tx-danger tx-spacing-1 mg-b-0 tx-medium">Cancellations</p>
                ...
                <table class="table table-dashboard mg-b-0">
                   ...
                   <tbody class="tx-13">
                      <tr>
                         ...
                         <td class="tx-gray-500 tx-right">$25,147 <span class="mg-l-5 tx-10  tx-success"><i class="ti-arrow-up tx-8"></i> 2.41%</span></td>
                      </tr>
                      <tr>
                         <td class="">03/04/2019</td>
                         <td class="tx-success tx-right">$28,325<small>.50</small></td>
                         <td class="tx-primary tx-right">4,257</td>
                         <td class="tx-gray-500 tx-right">$24,152 <span class="mg-l-5 tx-10  tx-danger"><i class="ti-arrow-down tx-8"></i> 2.41%</span></td>
                      </tr>
                      <tr>
                         <td class="">01/05/2019</td>
                         <td class="tx-success tx-right">$26,789<small>.50</small></td>
                         <td class="tx-primary tx-right">3,271</td>
                         <td class="tx-gray-500 tx-right">$20,369 <span class="mg-l-5 tx-10  tx-success"><i class="ti-arrow-up tx-8"></i> 2.41%</span></td>
                      </tr>
                      <tr>
                         <td class="">08/05/2019</td>
                         <td class="tx-success tx-right">$22,963<small>.50</small></td>
                         <td class="tx-primary tx-right">2,854</td>
                         <td class="tx-gray-500 tx-right">$19,475 <span class="mg-l-5 tx-10  tx-success"><i class="ti-arrow-up tx-8"></i> 2.41%</span></td>
                      </tr>
                      <tr>
                         <td class="">12/06/2019</td>
                         <td class="tx-success tx-right">$20,145<small>.50</small></td>
                         <td class="tx-primary tx-right">2,147</td>
                         <td class="tx-gray-500 tx-right">$14,478 <span class="mg-l-5 tx-10  tx-danger"><i class="ti-arrow-down tx-8"></i> 2.41%</span></td>
                      </tr>
                      <tr>
                         <td class="">22/06/2019</td>
                         <td class="tx-success tx-right">$18,123<small>.50</small></td>
                         <td class="tx-primary tx-right">1,563</td>
                         <td class="tx-gray-500 tx-right">$12,452 <span class="mg-l-5 tx-10  tx-success"><i class="ti-arrow-up tx-8"></i> 2.41%</span></td>
                      </tr>
                   </tbody>
                </table>
             </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-7 col-lg-8 col-xl-6">
                      <div class="pd-0">
                         ...
                         <p class="tx-11 tx-sm-12 mg-b-0 tx-gray-500">Habi tasse labo rum purus, vesti bulum at<span class="d-none d-sm-inline"> vivamus tempor port titor vulpu</span>... <a href="">Learn More</a></p>
                      </div>
                   </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                   ...
                   <div class="col-md-7 col-lg-8 col-xl-6">
                      <div class="pd-0">
                         ...
                         <p class="tx-12 mg-b-0 tx-gray-500">Habi tasse labo rum purus, vesti bulum<span class="d-none d-sm-inline"> at vivamus tempor port titor vulpu</span>... <a href="">Learn More</a></p>
                      </div>
                   </div>
                </div>
                <!-- row -->
             ...
             <div class="card-body pd-y-20">
                <ul class="list-unstyled mb-0">
                   <li class="d-flex align-items-center mg-b-15">
                      <a href="">
                         <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-gray-800">A</span><i></i></div>
                      </a>
                      ...
                      <div class="mg-l-auto d-flex align-self-center action-icon">
                         <nav class="nav nav-icon-only">
                            <a href="" data-toggle="tooltip" class="mr-2 tx-gray-500" title="" data-placement="top" data-original-title="Send Message"><i data-feather="mail" class="wd-16"></i></a>							 
                            <a href="" data-toggle="tooltip" class="mr-2 tx-gray-500" title="" data-placement="top" data-original-title="Add to Fiend"><i data-feather="user-plus" class="wd-16"></i></a>							  
                            <a href="" class="mr-2 tx-gray-500" data-toggle="tooltip" title="" data-placement="top" data-original-title="Flag User"><i data-feather="flag" class="wd-16"></i></a>
                            <a href="" data-toggle="tooltip" class="tx-gray-500" title="" data-placement="top" data-original-title="More Options"><i data-feather="more-vertical" class="wd-16"></i></a>
                         </nav>
                      </div>
                   </li>
                   <li class="d-flex align-items-center mg-b-15">
                   ...
                   <li class="d-flex align-items-center mg-b-15">
                      <a href="">
                         <div class="avatar avatar-offline"><span class="avatar-initial rounded-circle bg-teal">K</span><i></i></div>
                      </a>
                      <div class="media-body pd-l-15 lh-2">
                   ...
                   <li class="d-flex align-items-center mg-b-15">
                      <a href="">
                         <div class="avatar avatar-offline"><span class="avatar-initial rounded-circle bg-success">V</span><i></i></div>
                      </a>
                      <div class="media-body pd-l-15 lh-2">
                   ...
                   <li class="d-flex align-items-center mg-b-15">
                      <a href="">
                         <div class="avatar avatar-offline"><span class="avatar-initial rounded-circle bg-primary">M</span><i></i></div>
                      </a>
                      <div class="media-body pd-l-15 lh-2">
                   ...
                   <li class="d-flex align-items-center">
                      <a href="">
                         <div class="avatar avatar-offline"><span class="avatar-initial rounded-circle bg-warning">M</span><i></i></div>
                      </a>
                      <div class="media-body pd-l-15 lh-2">
             ...
             <div class="card-body pd-0 pd-y-15">
                <ul class="list-group list-group-flush tx-13">
                   <li class="list-group-item d-flex pd-y-9 pd-sm-x-20">
                      <div class="d-none d-sm-block"><span class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded bg-primary tx-white"><i class="ti-check"></i></span></div>
                      <div class="pd-sm-l-10">
                         <p class="mg-b-0">Lorem Ipsum is simply <a href="" class="tx-dark mg-b-0 tx-semibold">#985632</a></p>
                   ...
                   <li class="list-group-item d-flex pd-y-9 pd-sm-x-20">
                      <div class="d-none d-sm-block"><span class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded bg-warning tx-dark"><i class="ti-anchor"></i></span></div>
                      <div class="pd-sm-l-10">
                         <p class="mg-b-0">Lorem Ipsum is simply <a href="" class="tx-dark mg-b-0 tx-semibold">#698524</a></p>
                   ...
                   <li class="list-group-item d-flex pd-y-9 pd-sm-x-20">
                      <div class="d-none d-sm-block"><span class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded bg-primary tx-white"><i class="ti-check"></i></span></div>
                      <div class="pd-sm-l-10">
                         <p class="mg-b-0">Lorem Ipsum is simply <a href="" class="tx-dark mg-b-0 tx-semibold">#458762</a></p>
                   ...
                   <li class="list-group-item d-flex pd-y-9 pd-sm-x-20">
                      <div class="d-none d-sm-block"><span class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded bg-primary tx-white"><i class="ti-check"></i></span></div>
                      <div class="pd-sm-l-10">
                         <p class="mg-b-0">Lorem Ipsum is simply <a href="" class="tx-dark mg-b-0 tx-semibold">#365845</a></p>
                   ...
                   <li class="list-group-item d-flex pd-y-9 pd-sm-x-20">
                      <div class="d-none d-sm-block"><span class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded bg-danger tx-white"><i class="ti-close"></i></span></div>
                      <div class="pd-sm-l-10">
                         <p class="mg-b-0">Lorem Ipsum is simply <a href="" class="tx-dark mg-b-0 tx-semibold">#475821</a></p>
       ...
       <div class="col-xl-4">
          <div class="card mg-b-30">
             ...
             <div class="card-body">
                ...
                <p class="tx-11 tx-sm-12 mg-b-20 tx-gray-500">Habi tasse labo rum purus, vesti bulum at<span class="d-none d-sm-inline"> vivamus tempor port titor vulpu</span>... <a href="">Learn More</a></p>
